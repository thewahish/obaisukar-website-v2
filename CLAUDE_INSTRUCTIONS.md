...
- **Description**: Intelligent multi-agent development workspace
- **Path**: /Volumes/Ai/Projects/website2.0
...
## Quick Notes
- Agents adapted for Static Website development
- Using HTML/CSS/JS stack
